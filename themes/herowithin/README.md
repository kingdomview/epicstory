...
**HeroWithin Formation Matrix Core** plugin.

## What changed from v0.1.7 (and why)

| Area | v0.1.7-draft | v2.0.0 rebuild |
|---|---|---|
| Design tokens | Provisional Ink/Paper/Stone/Forest palette, Libre Caslon / Work Sans | Figma HeroWithin canon — Charcoal/Forged-Gold palette, Playfair Display / Outfit / Inter |
...
| Header/footer | Duplicated generic + `-herowithin` parts | Single `header.html` / `footer.html` |
...
Child theme only — Twenty Twenty-Five must be present. Zip the `herowithin/` folder and
upload under Appearance → Themes, or deploy via Git/SFTP to
`wp-content/themes/herowithin/`.
